...
IC/IM期货不享受成分股分红，因此真实的超额贴水收益需扣除年化分红率：
真实年化超额贴水 = 原始年化贴水率 - 年化分红率

中证500（IC）年化分红率约 1.0%，中证1000（IM）约 0.8%。 若不修正，在贴水收窄
至5-6%的近年市场中，实际可获取的超额收益仅3-5%，远低于表观值
...
股债性价比指标可以用于衡量股票相对债券的投资价值，可作为可作为资产配置和股票择时的参考。
一般来说，股债性价比越高，即意味着相对债券，股票越被低估;反之，则代表股票越被高估。
。股债性价比的计算传统的股债性价比指标计算方法分为FED溢价法和股息率溢价法:

### 风险溢价/FED溢价

风险溢价(%) = 1/市盈率(%)  - 中国10年国债收益率
...
Z分数:                   -0.19 
```
![风险溢价](/doc/risk_value.jpg)

### 股息率溢价

股息率溢价 = 指数股息率-10年期国债收益率